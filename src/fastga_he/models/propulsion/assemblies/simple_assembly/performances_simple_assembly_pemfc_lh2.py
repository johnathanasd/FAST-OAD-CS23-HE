...
from ...components.tanks.cryogenic_hydrogen_tank import PerformancesCryogenicHydrogenTank
...
class PerformancesAssembly(om.Group):
    ...
    def setup(self):
        ...
        self.connect("pemfc_stack_1.fuel_consumed_t", "cryogenic_hydrogen_tank_1.fuel_consumed_t")

...
class SizingMotorLossCoefficientScaling(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.declare_partials(
            of="data:propulsion:he_power_train:simple_PMSM:" + motor_id + ":scaling:alpha",
            wrt="*",
            method="exact",
        )
        self.declare_partials(
            of="data:propulsion:he_power_train:simple_PMSM:" + motor_id + ":scaling:beta",
            wrt="*",
            method="exact",
        )
        self.declare_partials(
            of="data:propulsion:he_power_train:simple_PMSM:" + motor_id + ":scaling:gamma",
            wrt="*",
            method="exact",
        )
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        outputs["data:propulsion:he_power_train:simple_PMSM:" + motor_id + ":scaling:beta"] = beta_scaling
        outputs[
